"""
chapter10/rpi/moisture_calibrate_pico.py

Using MicroPython & Pico to measure maximum and minimum voltages using ADC

$ mpremote mount . run moisture_calibrate_pico.py
...
OUTPUT_FILE = "moisture_calibration_config_pico.py"
...
def main():
    ...
    output  = "# This file was automatically created by moisture_calibrate_pico.py\n"
