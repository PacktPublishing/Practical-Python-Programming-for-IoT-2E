...
$ mpremote mount . run hc-sr04_pico.py
...
def get_distance_cms():                                   # (7)
    ...
    timeout = (int)(ticks_ms() + (TIMEOUT_SECS * 1000))   # (8)
    ...
    elapsed_microseconds = ticks_diff(tick_end, tick_start) / 2                                # (9)
...
def echo_handler(pin):                                                                         # (11)
    ...
    if pin.value() == 1:
        tick_start = ticks_us() # Start Timer                                                  # (12)

    elif pin.value() == 0:
        tick_end = ticks_us()   # End Timer                                                    # (13)
